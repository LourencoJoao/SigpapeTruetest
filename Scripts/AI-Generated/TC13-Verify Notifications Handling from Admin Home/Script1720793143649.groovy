...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 2: Click on button login.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 3: Click on button welcomeSignIn.png')
...
"Step 9: Select service and subservice"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11: Click on link adminHome - Navigate to page authhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 12: Click on button login.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 13: Click on span bannerButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 15: Click on button notificationsDropdownIconButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 16: Click on button seeAll - Navigate to page adminnotifications.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 17: Click on button notificationsDropdownIconButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 18: Click on list object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 19: Click on button seeAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 20: Click on input formSelectOriginLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 21: Click on div formSvg.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 22: Click on input search - Navigate to page .png')

"Step 23: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Notifications Handling from Admin Home_visual_checkpoint')
