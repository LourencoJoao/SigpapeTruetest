...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 2: Click on button welcomeSignIn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 4: Click on link serviceRequest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 6: Click on span button - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Program Enrollment with Span Button_visual_checkpoint')
