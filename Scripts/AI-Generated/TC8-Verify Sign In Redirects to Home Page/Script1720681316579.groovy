...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2: Click on button signIn.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Sign In Redirects to Home Page_visual_checkpoint')
