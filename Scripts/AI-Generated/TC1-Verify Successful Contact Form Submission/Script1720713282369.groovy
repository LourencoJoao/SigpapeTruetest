...
"Step 9: Enter input value in textarea enterYourMessage"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/admin/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_admin/textarea_enterYourMessage'), var_5_textarea_enterYourMessage)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 9: Enter input value in textarea enterYourMessage.png')
