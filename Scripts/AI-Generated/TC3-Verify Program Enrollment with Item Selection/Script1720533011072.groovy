...
"Step 6: Click on item mui8369Option0"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/admin/application-create?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_admin_application_create/item_mui8369Option0'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 6: Click on item mui8369Option0.png')
...
"Step 8: Click on button leave -> Navigate to page 'admin/home'"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/admin/application-create?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_admin_application_create/button_leave_1'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 8: Click on button leave - Navigate to page adminhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9: Click on link serviceRequest.png')

"Step 10: Select program options and proceed to next steps"

selectProgramOptionsAndProceed.execute()

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Program Enrollment with Item Selection_visual_checkpoint')
