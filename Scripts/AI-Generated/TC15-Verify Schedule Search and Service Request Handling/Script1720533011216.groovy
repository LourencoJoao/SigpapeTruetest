...
WebUI.setText(findTestObject('AI-Generated/Page_admin_informationDissemination_schedule/input_search'), input_searchtext)
...
"Step 20: Click on item mui74876Option0 -> Navigate to page 'admin/home'"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/admin/application-create?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_admin_application_create/item_mui74876Option0'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 20: Click on item mui74876Option0 - Navigate to page adminhome.png')
...
"Step 23: Click on item mui74876Option0 -> Navigate to page ''"

//WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/admin/application-create?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_admin_application_create/item_mui74876Option0'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 23: Click on item mui74876Option0 - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Schedule Search and Service Request Handling_visual_checkpoint')
