...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 2: Click on button welcomeSignIn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4: Click on button seeMore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5: Click on link serviceRequest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7: Click on button ok - Navigate to page adminmy-applicationsgovernment-program-application.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8: Click on link serviceRequest - Navigate to page adminapplication-create.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 9: Click on link serviceRequest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 10: Click on link adminHome - Navigate to page adminhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 11: Click on link serviceRequest - Navigate to page adminapplication-create.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 12: Click on link serviceRequest.png')

"Step 13: Select program options and proceed to next steps"

selectProgramOptionsAndProceed.execute()

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Service Request Handling with See More Option_visual_checkpoint')
